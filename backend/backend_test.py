...
Testing blockchain endpoints...")
        ...
        print("â Chain endpoint working")
...
Testing mining functionality...")
        ...
        print("â Mining endpoint working")
        ...
        print("â Chain length increased after mining")
...
Testing transaction functionality...")
        ...
        print("â Transaction creation working")
        ...
        print("â Transaction retrieval working")
...
Testing data input and self-replication...")
        ...
        print("â Data input processing working")

        # Verify self-replication occurred
        self.assertGreater(result["replications"], 0)
        print("â Self-replication mechanism working")
        ...
        print("â Data inputs retrieval working")
        print("â Self-replicated data verified")
